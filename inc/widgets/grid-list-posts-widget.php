<?php
if ( ! class_exists( 'Infinite_News_Grid_List_Posts_Widget' ) ) {
	/**
	 * Adds Infinite_News_Grid_List_Posts_Widget Widget.
	 */
	class Infinite_News_Grid_List_Posts_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$infinite_news_grid_list_posts_widget_ops = array(
				'classname'   => 'grid-list-posts ascendoor-widget',
				'description' => __( 'Retrive Grid List Posts Widgets', 'infinite-news' ),
			);
			parent::__construct(
				'infinite_news_grid_list_posts_widget',
				__( 'Ascendoor Grid List Posts Widget', 'infinite-news' ),
				$infinite_news_grid_list_posts_widget_ops
			);
		}
